    ...
    render(
      <STTEvaluationLeaderboard
        ...
        providerResults={[
          ...
          { provider: "deepgram", metrics: { cost: { cost_per_minute_usd: 0.002 } } },
        ]}
      />,
    );
...
describe("TTSEvaluationLeaderboard Pareto frontier", () => {
  it("renders the Pareto chart using the primary evaluator for quality", () => {
    render(
      <TTSEvaluationLeaderboard
        leaderboardSummary={[
          { run: "eleven", nat: 0.9, cost_per_minute_usd: 0.01 },
          { run: "azure", nat: 0.7, cost_per_minute_usd: 0.006 },
        ]}
        evaluatorColumns={[
  ...
  it("omits the Pareto chart when there is no evaluator to score quality", () => {
    render(
      <TTSEvaluationLeaderboard
        leaderboardSummary={[
          { run: "eleven", cost_per_minute_usd: 0.01 },
          { run: "azure", cost_per_minute_usd: 0.006 },
        ]}
        evaluatorColumns={[]}
        getProviderLabel={getProviderLabel}
      />,
