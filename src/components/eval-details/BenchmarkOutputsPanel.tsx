    ...
    <div className="flex h-full overflow-hidden" style={height ? { height } : undefined}>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto">
          {!selectedTestResult && selectedTest && showRunningSpinner ? (
            // The selected test has not started yet, so there is no row to
            // read: the run window picks the first test before the first
            // model has answered.
