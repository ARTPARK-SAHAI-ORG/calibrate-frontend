...
/** An easel with a line chart: the icon on every Compare models button. */
...
// Check Circle Icon (circled checkmark for verification)
...
/** An arrow leaving a box. Marks a link that opens somewhere outside the app,
 * so a link does not have to rely on an underline to read as a link. */
...
// Filter Icon (funnel, for the control that narrows a list)
