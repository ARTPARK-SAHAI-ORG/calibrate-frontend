...
export function AddTestDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Create-phase intro: pick what to test, preview an example of that
          kind of test, then continue. Once confirmed, the type is locked for
          this test — same as an existing test's type cannot be changed. */}
      {!typeChosen && (
        <TestTypePicker
          title="Create a test"
          agentNature={agentNature}
          onNext={chooseTestType}
          onClose={onClose}
        />
      )}
